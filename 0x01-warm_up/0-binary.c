...
/**
 * print_digit - This helper function will print the array contents with message
 *
 * array - is the pointer to the first element of the array to search in
 * left - this is the left side of the array
 * right - this is the right side of the array
 *
 * Return: void
 */
